...
export default function TicketsView({ tickets }: TicketsViewProps) {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="flex w-full justify-between items-center p-4 rounded-lg shadow-sm hover:shadow bg-slate-200 dark:bg-slate-900 hover:bg-slate-300 hover:dark:bg-slate-700 transition-all duration-200">
